    ...
    const initPeer = async (retryCount = 0) => {
      ...
      peer.on('open', (id) => {
        ...
        if (!navigator.mediaDevices || !navigator.mediaDevices.getUserMedia) {
            ...
            setFatalError("L'accès à la caméra est bloqué par le navigateur. Si vous êtes sur mobile via une IP locale, vous devez utiliser HTTPS ou un tunnel (ex: ngrok).");
            return;
        }
